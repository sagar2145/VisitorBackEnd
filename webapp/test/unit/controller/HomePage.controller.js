...
sap.ui.define([
	"com/incture/cherrywork/GuestManagmentSystem/controller/HomePage.controller"
	...
	QUnit.test("I should test the app controller loads", function (assert) {
		...
		assert.ok(sName, "com/incture/cherrywork/GuestManagmentSystem.controller.HomePage");
	});
